...
@implementation CIColorDodgeBlendModeView

static NSString *FILTER_NAME     = @"CIColorDodgeBlendMode";
static NSString *CELL_IDENTIFIER = @"Cell";

- (id)initWithFrame:(CGRect)frame filterParams:(NSArray *)filterParams
{
    CIColorDodgeBlendModeView *loadedView = [[CIColorDodgeBlendModeView alloc] initWithNibName:@"CIColorDodgeBlendModeView"];
